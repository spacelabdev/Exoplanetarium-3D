...
const Database = ({ planetSelected, showDatabase, setShowDatabase }) => {
  ...
  const filteredExoplanets = planetdata.filter((planet) =>
    ...
    <div>
      <div className={`exoplanet-database ${showDatabase ? "open" : ""}`}>
        ...
        <div className="exoplanets">
          ...
          {filteredExoplanets.map((planet) => (
            ...
            >
              <img
                src={planet.photo || placeholderPhoto}
                alt={planet.name}
                className="photo"
              />
              <div className="exoplanet-info">
                <p className="exoplanet-name">{planet.name}</p>
      ...
      <div
        className={`database-icon ${
          showDatabase ? "transparent unclickable" : ""
        }`}
